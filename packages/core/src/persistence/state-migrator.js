...
exports.MIGRATIONS = exports.StateMigrator = void 0;
const logger_1 = require("../utils/logger");
const log = new logger_1.Logger('Migrator');
// ─── Migration Registry ───
/**
...
class StateMigrator {
    store;
    migrations;
    constructor(store, customMigrations) {
        this.store = store;
...
exports.StateMigrator = StateMigrator;
