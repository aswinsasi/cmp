...
exports.WasmModuleBuilder = exports.Op = void 0;
exports.encodeLEB128 = encodeLEB128;
exports.encodeSignedLEB128 = encodeSignedLEB128;
// ─── WASM Opcodes ───
exports.Op = {
    // Control
...
class WasmModuleBuilder {
     ...
     */
    addFunction(typeIndex, locals, code) {
    ...
    build() {
        ...
        if (this.types.length > 0) {
            const content = [...encodeLEB128(this.types.length)];
        ...
        if (this.exports.length > 0) {
            const content = [...encodeLEB128(this.exports.length)];
        ...
        if (this.bodies.length > 0) {
            const bodiesBytes = [...encodeLEB128(this.bodies.length)];
            for (const body of this.bodies) {
                ...
                // Code + end
                funcBody.push(...body.code, exports.Op.end);
                // Wrap with size
     ...
     */
    static buildProcessModule(params, results, locals, code, memoryPages = 1) {
...
exports.WasmModuleBuilder = WasmModuleBuilder;
//# sourceMappingURL=wasm-module-builder.js.map