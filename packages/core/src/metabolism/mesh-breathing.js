...
class MeshBreathing {
    ...
    getSummary() {
        const distribution = {
            [metabolism_1.MetabolicState.ANABOLIC]: 0,
            [metabolism_1.MetabolicState.HOMEOSTATIC]: 0,
            [metabolism_1.MetabolicState.CATABOLIC]: 0,
            [metabolism_1.MetabolicState.DORMANT]: 0,
            [metabolism_1.MetabolicState.CHARGING]: 0,
        };
        let totalBudget = 0;
     ...
     */
    generateForecast(currentBudget, totalDelta, deviceCount) {
        const forecast = [];
...
exports.MeshBreathing = MeshBreathing;
//# sourceMappingURL=mesh-breathing.js.map