...
exports.MeshFS = void 0;
const logger_1 = require("../utils/logger");
const path_resolver_1 = require("./path-resolver");
const meshfs_types_1 = require("./meshfs-types");
const log = new logger_1.Logger('MeshFS');
// ─── Simple Hash ───
...
class MeshFS {
    ...
    constructor(localDeviceId, config = {}) {
        ...
        this.config = { ...meshfs_types_1.DEFAULT_MESHFS_CONFIG, ...config };
        this.resolver = new path_resolver_1.PathResolver(this.config.maxPathDepth);
    }
    // ══════════════════════════════════════
    // Write
    // ══════════════════════════════════════
...
exports.MeshFS = MeshFS;
//# sourceMappingURL=meshfs.js.map