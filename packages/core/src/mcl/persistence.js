...
exports.SQLiteMERPersistence = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const __1 = require("../");
const log = new __1.Logger('MERPersist');
/**
...
class SQLiteMERPersistence {
    ...
    save(mer) {
        this.ensureInit();
        const merIdHex = (0, __1.toHex)(mer.merId);
        this.db.run(`
    ...
    `, [
            ...
            (0, __1.toHex)(mer.learnedHints.bestTierMapping),
            mer.learnedHints.bottleneckFlags,
            (0, __1.toHex)(mer.environmentHash),
            mer.confidence,
            mer.generation,
            mer.createdAt,
            mer.ttlDays,
            (0, __1.toHex)(mer.originMeshHash),
            (0, __1.toHex)(mer.signature),
        ]);
        this.flush();
     ...
     */
    deleteMany(merIdHexes) {
        this.ensureInit();
        if (merIdHexes.length === 0)
            return;
...
exports.SQLiteMERPersistence = SQLiteMERPersistence;
