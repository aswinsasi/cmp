...
export class NegotiationEngine {
  ...
  private activeNegotiations = new Map<string, { resolve: Function; timer?: ReturnType<typeof setTimeout>; expectedBids?: number }>();
  ...
  private collectBids(taskHex: string, windowMs: number, expectedBids: number = 0): Promise<CMPBid[]> {
